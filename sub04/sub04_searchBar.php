...
function groupStockCheck(){
	...
	if(groupStock == ''){
		...
		id = setTimeout(function(){
			...
			jQuery.ajax({
				url: '/module/json/userPortfolioStock.php',
				type: 'POST',
				data:params,
				dataType: 'html',
				success: function(result){
					if(result){
						...
						if(code == '99'){
							...
							strHtml += "<td id='symbol_"+uid+"'>"+symbol+"</td>";
							strHtml += "<td><input type='text' name='msg_"+uid+"' value='' class='msgData'></td>";
							strHtml += "<td><input type='text' name='sNum_"+uid+"' id='sNum_"+uid+"' value='' class='numberOnly'>개</td>";
							strHtml += "<td><input type='text' name='sAmt_"+uid+"' id='sAmt_"+uid+"' value='' class='numberOnly'>달러</td>";
							strHtml += "<td>";
							strHtml += "<input type='hidden' name='chk[]' value='"+uid+"' class='chklist'>";
							strHtml += "<input type='text' name='sExc_"+uid+"' id='sExc_"+uid+"' value='"+exRate+"' class='numberOnly'>원";
