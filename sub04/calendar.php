...
function moreWrap(d){
	...
	parent.iFrameHeight('ifra_calendar2');
}
...
?>
		...
		<td style='width:14.28%;height:<?=$cellh?>;vertical-align:top;<?=$tdgcolor?>'>
			...
			?>
				<tr>
					<td style='padding:5px;cursor:pointer;' onclick="parent.dividendCall('<?=$r?>');"><span class=<?=$style?> <?=$date_title?>><?=$date2?></span></a> <?=$todayTxt?></td>
				</tr>
			<?
				}else{
			?>
