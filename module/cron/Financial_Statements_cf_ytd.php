...
$logFile = '/home/myss/www/module/cron/log/Financial_Statements_cf_ytd.log';
...
/*
		if($symbol != $reSymbol){
			sqlExe("update api_Financial_Statements_cf_ytd set reSymbol='".$reSymbol."' where symbol='".$symbol."'");
		}
*/
