...
$logFile = '/home/myss/www/module/cron/log/Financial_Statements_cf_ttm.log';
...
/*
		if($symbol != $reSymbol){
			sqlExe("update api_Financial_Statements_cf_ttm set reSymbol='".$reSymbol."' where symbol='".$symbol."'");
		}
*/
