...
<script>
	$(function () {
		...
		//첫번째 버튼 클릭시
		document.getElementById('addData01').addEventListener('click', () => {
			...
			document.getElementById( 'addData03' ).removeAttribute( 'disabled' );
		});
		//두번째 버튼 클릭시
		document.getElementById('addData02').addEventListener('click', () => {
		...
		//세번째 버튼 클릭시
		document.getElementById('addData03').addEventListener('click', () => {

				var seriesLength = mddCom.series.length;
				for(var i = seriesLength -1; i > -1; i--) {
					mddCom.series[i].remove();
				}
			  document.getElementById( 'addData03' ).setAttribute("disabled");
		});
