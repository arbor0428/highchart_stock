			...
			<div class="etf_tab_flex">
				<div class="etf_tab_box">
					<div class="etf">
						...
						<?
							//급등주(ETF == Y)
							$row = sqlArray("select s.*, c.name from Stock_Candles_Last as s left join ks_symbol as t on s.symbol=t.symbol left join api_Company_Profile as c on s.symbol=c.symbol where t.etf='Y' order by s.pmDataDay desc limit 10");
				...
				<div class="etf_tab_box">
					<div class="etf">
						...
						<?
							//거래량 급등주(ETF == Y)
							$row = sqlArray("select s.*, c.name from Stock_Candles_Last as s left join ks_symbol as t on s.symbol=t.symbol left join api_Company_Profile as c on s.symbol=c.symbol where t.etf='Y' order by s.vDataDay desc limit 10");
				...
				<div class="etf_tab_box">
					<div class="etf">
						...
						<?
							//52주 신고가(ETF == Y)
							$row = sqlArray("select s.*, e.name from Stock_Candles_Last as s left join ks_symbol as t on s.symbol=t.symbol left join api_ETFs_Profile as e on s.symbol=e.symbol where t.etf='Y' and s.high52='1' order by e.aum desc limit 10");
				...
				<div class="etf_tab_box">
					<div class="etf">
						...
						<?
							//급락주(ETF == N)
							$row = sqlArray("select s.*, c.name from Stock_Candles_Last as s left join ks_symbol as t on s.symbol=t.symbol left join api_Company_Profile as c on s.symbol=c.symbol where t.etf='Y' and s.c>0 order by s.pmDataDay asc limit 10");
				...
				<div class="etf_tab_box">
					<div class="etf">
						...
						<?
							//52주 신저가(ETF == N)
							$row = sqlArray("select s.*, e.name from Stock_Candles_Last as s left join ks_symbol as t on s.symbol=t.symbol left join api_ETFs_Profile as e on s.symbol=e.symbol where t.etf='Y' and s.low52='1' order by e.aum desc limit 10");
