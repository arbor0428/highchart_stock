...
function ownership(t){
	if(t == 'owner')					act = 'ownerFrame.php';
	else if(t == 'fundowner')		act = 'fundownerFrame.php';
	else								act = '';

	if(act){
		$("#multiBox").css({"width":"80%","max-width":"1280px"});
		$("#multiFrame").html("<iframe src='"+act+"?symbol=<?=$gbl_symbol?>' name='' style='width:100%;height:700px;' frameborder='0' scrolling='auto'></iframe>");
		$(".multiBox_open").click();
	}
}
</script>

<div class="ticker_section" style="margin-bottom: 100px;">
	<p class="sub_tit">이 많은 주식 · · · 누구의 손에 있는 걸까요?</p>
	<div class="stocksHand_tbl">
		<table class="subtable">
			<tbody>
				...
				<tr>
					<td style="text-align: left;"><div class="dp_f dp_c" style="position: relative;"><span class="sCir blue"></span>주주 (기관,내부자)<a class="viewmore" href="javascript:ownership('owner');"><span>+</span></a></div></td>
					<td title='보유 주식수'><?=$sTxt01?> 주</td>
					<td title='시장가치'><?=$vTxt01?> 달러<br><?=$wTxt01?>원</td>
					<td title='전제주식 대비 비중'><?=$per01?>%</td>
					<td title='비율' rowspan="4">
					<?
						include 'analyst_cir.php';
					?>
					</td>
				</tr>
				<tr>
					<td style="text-align: left;"><div class="dp_f dp_c"><span class="sCir green"></span>펀드, ETF 등<a class="viewmore" href="javascript:ownership('fundowner');"><span>+</span></a></div></td>
					<td title='보유 주식수'><?=$sTxt02?> 주</td>
					<td title='시장가치'><?=$vTxt02?> 달러<br><?=$wTxt02?>원</td>
					<td class="brr" title='전제주식 대비 비중'><?=$per02?>%</td>
				</tr>
				<tr>
					<td style="text-align: left;"><div class="dp_f dp_c"><span class="sCir yellow"></span>개인 투자자, 기타</div></td>
					<td title='보유 주식수'><?=$sTxt03?> 주</td>
					<td title='시장가치'><?=$vTxt03?> 달러<br><?=$wTxt03?>원</td>
					<td class="brr" title='전제주식 대비 비중'><?=$per03?>%</td>
				</tr>
				<tr>
					<td style="text-align: left;">총합</td>
					<td title='보유 주식수'><?=$sTxtTot?> 주</td>
					<td title='시장가치'><?=$vTxtTot?> 달러<br><?=$wTxtTot?>원</td>
					<td class="brr" title='전제주식 대비 비중'>100%</td>
				</tr>
			</tbody>
		</table>
	</div>
