...
<!-- 			<div class="ora_line"></div> -->
			<div class="login_inner">
				<h3 class="mem_tit">비밀번호 찾기</h3>
				<div class="idpassBox">
					<input type="text" name="f_userid" id="f_userid" class="input_text medium" placeholder="아이디" onkeypress="" autocomplete="off">
				</div>
				<div class="idpassBox">
				...
				<div class="txt_c" style=" justify-content: center;">
					<a href="search_id.php" class="member-btn" style="padding-left:0; text-align: center;">아이디를 잊으셨습니까?</a>
				</div>
			</div>
		</div>	
	</div>
