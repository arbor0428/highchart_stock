<?
	...
	$row = sqlRow("select * from ks_userGroup where userid='".$GBL_USERID."' and uid=".$uid."");
	if(!$row){
		Msg::backMsg('접근오류');
		exit;
...
<p style='padding-bottom:5px;'>* 그룹명 및 그룹메모를 수정할 수 있습니다.</p>
