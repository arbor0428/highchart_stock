...
function newsList(){
	...
	parent.$('#newsList_ttl').text("미국증시뉴스");
	parent.$('#newsListFrame').html("<iframe name='newsList' id='newsList' src='MarketNewsList.php' style='width:100%;height:600px;' frameborder='0' scrolling='auto'></iframe>");
